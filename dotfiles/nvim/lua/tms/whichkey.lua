...
which_key.add({
    ...
    { "<Leader>ee",        ":Trouble<CR>",                                                          desc = "Trouble Window" },
    { "<Leader>e<Leader>", ":TodoTelescope<CR>",                                                    desc = "Telescope TODO" },
    { "<Leader>f",         group = "File" },
    { "<Leader>fb",        "<CMD>Telescope buffers<CR>",                                            desc = "Show Buffers" },
    { "<Leader>fe",        "<CMD>Sexplore<CR>",                                                     desc = "File Explorer" },
    { "<Leader>ft",        ":lua MiniFiles.open()<CR>",                                             desc = "File Tree" },
    ...
    { "<Leader>lgi",       ":lua require('telescope.builtin').lsp_implementations{}<CR>",           desc = "[G]oto [I]mplementations" },
    { "<Leader>lgr",       ":lua require('telescope.builtin').lsp_references{}<CR>",                desc = "[G]oto [R]eferences" },
    { "<Leader>lh",        "<CMD>lua vim.lsp.buf.hover()<CR>",                                      desc = "Hover" },
    { "<Leader>ll",        group = "Server" },
    { "<Leader>lli",       ":checkhealth vim.lsp<CR>",                                              desc = "LSP Info" },
    ...
    { "<Leader>tt",        ":TMSTogTerm Main<CR>",                                                  desc = "[T]oggle Terminal" },
    { "<Leader>tr",        ":TMSTogTermRename<CR>",                                                 desc = "[R]ename Terminal" },
    { "<Leader>tc",        ":TMSTogTermSendLineToScratch<CR>",                                      desc = "Send [C]urrent Line to Scratch" },
